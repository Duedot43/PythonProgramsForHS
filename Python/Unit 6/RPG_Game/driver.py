...
#TODO **Fighting system,   **selling systemDONE!,    *seeing system - binoc system done, need to get a inventory seeing system,     *eating system,     *looting system,     **unlocking system
#**Jack
#* Eli
