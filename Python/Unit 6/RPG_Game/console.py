        ...
        if at.outpost(player_list) == True:
            ...
            if raw_input[0] == "bow":
                if get.outpost(1,get.pos2outpost(player_list), var_list) == 5:
                    ...
                    print("There is no bread here.")
            if raw_input[0] == "arrow" or raw_input[0] == "arrows":
